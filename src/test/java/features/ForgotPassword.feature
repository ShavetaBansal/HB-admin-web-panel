...
@tagname
  ...
  #Test-003
  Scenario: Validate if user enters unauthorized email and clicks on Get Password Reset Link button error message should be displayed
  ...
  #Test-003
  Scenario: Validate if user enters invalid email and clicks on Get Password Reset Link button error message should be displayed

    Given user enters invalid "admin@memorres.c" email ID
    And user clicks on Get Password Reset Link button
    Then error message should be displayed correctly for invalid email

  #Test-004
  Scenario: Validate if user does not enter any email and clicks on Get Password Reset Link button error message should be displayed
  ...
  #Test-005
  Scenario: Verify confirmation message after entering valid mail and clicking on Get Password Reset link button

    Given user enters a valid and authorized "admin@memorres.com" email ID
    And user clicks on Get Password Reset Link button
